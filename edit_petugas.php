<?php
	...
	$query = mysql_query("SELECT * from petugas where petugas_kode = '$id'");
...
<html>
	<head>
		<title>Petugas | Edit Data | Perpustakaan</title>
		...
		<div id="container-utama">
			...
			<div class="content">
				<div class="alamat-link">
					<a href="kategori.php"><p>> Petugas </a>> Edit Data</p></a>
				</div>

				<div class="tabel">
					<div class="judul-tab">
						<a href="petugas.php"><img src="img/left-arrow.png"></a>
						<p>Edit Data Petugas</p>
					</div>
							...
							<form method="POST" action="proses_edit_petugas.php">
								<table border="0" cellspacing="0" cellpadding="7" align="center">
									...
									<tr>
										<td>Nama Petugas</td>
										<td>:</td>
										<td><input type="text" name="nama_ptgs" value="<?php echo $row['petugas_nama']?>" placeholder="Nama Petugas" required/></td>
									</tr>
									<tr>
