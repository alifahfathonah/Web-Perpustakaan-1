				...
				<div class="tabel-utama">
					...
					<table border="0" cellpadding="10" cellspacing="0" align="center">
						<tr style="background: white;">
							<td colspan="10" align="right"><a href="tambah_peminjaman.php"><input type="submit" name="tambah-data" value=" +   Tambah Data"></td>
						</tr>
						<tr>
							...
							<td style="border-bottom: 1px solid #808080;" width="150px" align="center">Tanggal Peminjaman</td>
							<td style="border-bottom: 1px solid #808080;" width="120px" align="center">Tanggal Kembali</td>
							<td style="border-bottom: 1px solid #808080;" width="80px" align="center">Aksi</td>
						</tr>

						<?php 
							$query = mysql_query("SELECT * from peminjaman order by peminjaman_kode asc") or die (mysql_error());
							...
							while ($row = mysql_fetch_array($query)) {
								echo '<tr align="center">';
									...
									echo '<td style="border-bottom: 1px solid #808080;">'.$row['peminjaman_tgl'].'</td>';
									echo '<td style="border-bottom: 1px solid #808080;">'.$row['peminjaman_tgl_hrs_kembali'].'</td>';
									echo '<td style="border-bottom: 1px solid #808080;" align="center"><a href="edit_peminjaman.php?edit='.$row['peminjaman_kode'].'"><img src="img/edit.png" class="icon-aksi"/></a> <a href="hapus_peminjaman.php?hapus='.$row['peminjaman_kode'].'"><img src="img/delete.png" class="icon-aksi"/></a></td>';
								echo '</tr>';
