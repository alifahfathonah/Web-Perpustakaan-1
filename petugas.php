				...
				<div class="tabel-utama">
					...
					<table border="0" cellpadding="10" cellspacing="0" align="center">
						<tr style="background: white;">
							<td colspan="10" align="right"><a href="tambah_petugas.php"><input type="submit" name="tambah-data" value=" +   Tambah Data"></td>
						</tr>
						<tr>
							<td style="border-bottom: 1px solid #808080;" width="20px" align="center">No</td>
							<td style="border-bottom: 1px solid #808080;" width="120px" align="center">Kode Petugas</td>
							<td style="border-bottom: 1px solid #808080;" width="110px" align="center">Nama Petugas</td>
							<td style="border-bottom: 1px solid #808080;" width="80px" align="center">Aksi</td>
						</tr>

						<?php 
							$query = mysql_query("SELECT * from petugas order by petugas_kode asc") or die (mysql_error());
							...
							while ($row = mysql_fetch_array($query)) {
								echo '<tr align="center">';
									...
									echo '<td style="border-bottom: 1px solid #808080;">'.$row['petugas_nama'].'</td>';
									echo '<td style="border-bottom: 1px solid #808080;" align="center"><a href="edit_petugas.php?edit='.$row['petugas_kode'].'"><img src="img/edit.png" class="icon-aksi"/></a> <a href="hapus_petugas.php?hapus='.$row['petugas_kode'].'"><img src="img/delete.png" class="icon-aksi"/></a></td>';
								echo '</tr>';
