...
<html>
	<head>
		<title>Buku | Tambah Data | Perpustakaan</title>
							...
							<form method="POST" action="proses_tambah_buku.php">
								<table border="0" cellspacing="0" cellpadding="7" align="center">
									...
									<tr>
										<td>Kode Kategori</td>
										<td>:</td>
										<td><input type="text" name="kd_ktgr" placeholder="Kode Kategori" required/></td>
									</tr>
									<tr>
										<td>Kode Penerbit</td>
										<td>:</td>
									...
									<tr>
										<td>Judul Buku</td>
										<td>:</td>
										<td><input type="text" name="judul_buku" placeholder="Judul Buku" required/></td>
									</tr>
									<tr>
										<td>Jumlah Buku</td>
										<td>:</td>
										<td><input type="number" name="jml_buku" placeholder="Jumlah Buku" required/></td>
									</tr>
									<tr>
										<td>Deskripsi</td>
										<td>:</td>
										<td><textarea name="desc_buku" placeholder="Deskripsi" required></textarea></td>
									</tr>
									<tr>
										<td>Pengarang</td>
										<td>:</td>
									...
									<tr>
										<td>Tahun Terbit</td>
										<td>:</td>
										<td><input type="text" name="thn_terbit" placeholder="Tahun Terbit" required/></td>
									</tr>
									<tr>
