...
<html>
	<head>
		<title>Kategori | Tambah Data | Perpustakaan</title>
		...
		<div id="container-utama">
			...
			<div class="content">
				<div class="alamat-link">
					<a href="kategori.php"><p>> Kategori </a>> Tambah Data</p></a>
				</div>
							...
							<form method="POST" action="proses_tambah_kategori.php">
								<table border="0" cellspacing="0" cellpadding="7" align="center">
									...
									<tr>
										<td>Nama Kategori</td>
										<td>:</td>
										<td><input type="text" name="nama_ktgr" placeholder="Nama Kategori" required/></td>
									</tr>
									<tr>
